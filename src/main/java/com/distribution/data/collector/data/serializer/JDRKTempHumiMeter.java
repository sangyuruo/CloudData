...
@Component
public class JDRKTempHumiMeter implements IMeterParser {

    //0103040020002e7be5
	private final Logger logger = LoggerFactory.getLogger(JDRKTempHumiMeter.class);
	public static final String[] strKeys = new String[]{"Humidity", "Temperature"};
