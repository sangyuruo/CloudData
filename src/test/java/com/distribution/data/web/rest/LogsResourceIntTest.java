...
import com.distribution.data.AbstractCassandraTest;
import com.distribution.data.EmCloudDataApp;
import com.distribution.data.config.SecurityBeanOverrideConfiguration;
import com.distribution.data.web.rest.vm.LoggerVM;
...
@SpringBootTest(classes = {EmCloudDataApp.class, SecurityBeanOverrideConfiguration.class})
